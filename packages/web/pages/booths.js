          ...
          <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-white">Booth Reservations</h1>
                  <p className="text-sm text-nh-teal mt-1 font-semibold">Reserve a booth for focused work</p>
                </div>
              </div>
            </div>
          </div>
